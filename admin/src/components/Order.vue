    ...
    <div class="order">
        <div class="content">
            ...
            <el-table :data="orderList" stripe border>
                ...
                <el-table-column prop="price" label="总支付" align="center"></el-table-column>
                ...
                <el-table-column prop="share" label="分销商" align="center"></el-table-column>
            </el-table>
        </div>
    </div>
</template>
