...
config.enemy_number_of_level = [{ r: 1, b: 1, y: 1, g: 0 }, { r: 1, b: 1, y: 1, g: 0 }, { r: 1, b: 1, y: 1, g: 1 }, { r: 1, b: 1, y: 1, g: 1 }, { r: 10, b: 5, y: 3, g: 0 }, { r: 15, b: 5, y: 5, g: 5 }, { r: 15, b: 5, y: 5, g: 5 }]; // 每一关的敌方坦克数量
config.default_scene = 'lawn'; // 默认场景
// 游戏参数
config.player1_lives = 10;
config.player1_speed = 2;
config.player1_move_keys = { 37: 'left', 38: 'up', 39: 'right', 40: 'down' };
config.player1_fire_key = 32;

config.player2_lives = 10;
