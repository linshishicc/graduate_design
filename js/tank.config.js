...
config.enemy_number_of_level = [{ r: 5, b: 3, y: 2, g: 0 }, { r: 10, b: 5, y: 3, g: 2 }, { r: 15, b: 5, y: 5, g: 5 }, { r: 5, b: 3, y: 2, g: 1 }, { r: 10, b: 5, y: 3, g: 2 }, { r: 15, b: 5, y: 5, g: 5 }, { r: 15, b: 5, y: 5, g: 5 }]; // 每一关的敌方坦克数量
config.default_scene = 'lawn'; // 默认场景

// 游戏参数
config.player1_lives = 100;
config.player1_speed = 2;
config.player1_move_keys = { 37: 'left', 38: 'up', 39: 'right', 40: 'down' };
config.player1_fire_key = 32;

config.player2_lives = 100;
